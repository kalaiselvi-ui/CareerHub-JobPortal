...
export const About: React.FC = () => {
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      {/* 1. Hero Section */}
      <section className="bg-gradient-to-br from-blue-600 via-indigo-600 to-slate-900 text-white py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="max-w-3xl mx-auto text-center space-y-4">
          <h2 className="text-3xl font-bold text-slate-900">About CareerHub</h2>
              ...
              <ol className="space-y-4">
                {[
                  ...
                  <li key={idx} className="flex gap-4">
                    <span className="flex items-center justify-center w-7 h-7 rounded-full bg-blue-600 text-white font-bold text-xs shrink-0">
                      {idx + 1}
                    </span>
                    <div>
            ...
            <div className="bg-slate-50 p-8 rounded-2xl border border-slate-200 space-y-6">
              ...
              <ol className="space-y-4">
                {[
                  ...
                  <li key={idx} className="flex gap-4">
                    <span className="flex items-center justify-center w-7 h-7 rounded-full bg-indigo-600 text-white font-bold text-xs shrink-0">
                      {idx + 1}
                    </span>
                    <div>
                      <h4 className="font-semibold text-slate-900 text-sm">
      ...
      <section className="py-16 bg-slate-100 border-t border-slate-200 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-4">
            ...
            <Link
              to="/jobs"
              className="inline-flex items-center gap-2 py-3 px-6 bg-blue-600 text-white font-medium text-sm rounded-xl hover:bg-blue-700 transition-colors shadow-md shadow-blue-600/20"
            >
              <span>Find Jobs</span>
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-4">
            <h3 className="text-2xl font-bold text-slate-900">Recruiters</h3>
            <p className="text-slate-600 text-sm">
              Find talented professionals and build your team with ease.
            </p>
            <Link
              to="/post-job"
              className="inline-flex items-center gap-2 py-3 px-6 bg-indigo-600 text-white font-medium text-sm rounded-xl hover:bg-indigo-700 transition-colors shadow-md shadow-indigo-600/20"
            >
      ...
      {/* 6. CTA Section */}
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-700 text-white text-center px-4">
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
            <Link
              to="/jobs"
              className="w-full sm:w-auto py-3 px-8 bg-white text-blue-600 font-bold rounded-xl shadow-lg hover:bg-blue-50 transition-colors text-sm"
            >
              Find Jobs
            </Link>
            <Link
              to="/register"
              className="w-full sm:w-auto py-3 px-8 bg-blue-700 border border-blue-400 text-white font-bold rounded-xl hover:bg-blue-800 transition-colors text-sm"
            >
              Join CareerHub
            </Link>
          </div>
